...
flags.DEFINE_string('log_dir', '../log_cifar10_conv/origin_v15_r1/train',
...
def main(train_dir, batch_size, num_batches, log_dir, lrn):
    ...
    loss_cat1 = tf.check_numerics(loss_cat1, "loss_1 nan or inf", name=None)
    loss_cat2 = tf.check_numerics(loss_cat2, "loss_2 nan orinf", name=None)
    total_loss = loss
    total_loss = tf.check_numerics(total_loss, "total_loss nan or inf", name=None)
