...
class graph(object):
   ...
   def _residual(self, net, in_filter, out_filter, prefix):
   ...
   def _bi_conv(self, net, in_filter, out_filter, prefix):
   ...
   def network(self, images, labels):
      ...
      logits_cat1 = self._cat1_logits(logits)
      logits_cat2 = self._cat2_logits(logits)
      
      labels_cat1 = self._cat1(labels)
      labels_cat2 = self._cat2(labels)
