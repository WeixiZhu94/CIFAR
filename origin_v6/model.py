...
def network(images, labels):
   ...
   net = _bi_conv(net, 16, 16, 'unit_16_4')
   net = _bi_conv(net, 16, 16, 'unit_16_5')
   net = _bi_conv(net, 16, 16, 'unit_16_6')
   net = slim.layers.max_pool2d(net, [2,2], scope='pool_1')

   net = _bi_conv(net, 16, 32, 'unit_32_1')
   net = _bi_conv(net, 16, 32, 'unit_32_2')
   net = _bi_conv(net, 16, 32, 'unit_32_3')
   net = _bi_conv(net, 16, 32, 'unit_32_4')
   net = _bi_conv(net, 16, 32, 'unit_32_5')
   net = _bi_conv(net, 16, 32, 'unit_32_6')
   net = slim.layers.max_pool2d(net, [2,2], scope='pool_2')

   net = _bi_conv(net, 32, 64, 'unit_64_1')
   net = _bi_conv(net, 32, 64, 'unit_64_2')
   net = _bi_conv(net, 32, 64, 'unit_64_3')
   net = _bi_conv(net, 32, 64, 'unit_64_4')
   net = _bi_conv(net, 32, 64, 'unit_64_5')
   net = _bi_conv(net, 32, 64, 'unit_64_6')
