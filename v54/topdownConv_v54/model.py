...
def network(net, labels):
   ...
   net = _bi_conv(net, 64, 64, 'unit_16_2')
   net = _bi_conv(net, 64, 64, 'unit_16_3')
   net = _bi_conv(net, 64, 64, 'unit_16_4')
   net = _bi_conv(net, 64, 64, 'unit_16_5')
   net = slim.layers.max_pool2d(net, [2,2], scope='pool_1')

   net = _bi_conv(net, 64, 128, 'unit_32_1')
   net = _bi_conv(net, 128, 128, 'unit_32_2')
   net = _bi_conv(net, 128, 128, 'unit_32_3')
   net = _bi_conv(net, 128, 128, 'unit_32_4')
   net = _bi_conv(net, 128, 128, 'unit_32_5')
   net = slim.layers.max_pool2d(net, [2,2], scope='pool_2')

   net = _bi_conv(net, 128, 256, 'unit_64_1')
   net = _bi_conv(net, 256, 256, 'unit_64_2')
   net = _bi_conv(net, 256, 256, 'unit_64_3')
   net = _bi_conv(net, 256, 256, 'unit_64_4')
   net = _bi_conv(net, 256, 256, 'unit_64_5')
